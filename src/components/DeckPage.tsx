    ...
    return (
        <div className="container mx-auto p-4">
            <header className="flex justify-between items-center mb-4">
                ...
                <button
                    className="text-2xl bg-black text-white rounded-full w-10 h-10 flex items-center justify-center" onClick={handleAddClick}>+
                </button>
            </header>
            ...
            <div className="mb-4 bg-white rounded-lg p-4 shadow flex justify-between items-center">
                <div>
                    ...
                    <div className="flex gap-4">
                        <span
                            className={`rounded-md px-2 py-1 font-bold ${0 === 0 ? 'bg-green-300' : 'bg-yellow-300'}`}>
                          {deckData?.toReview} to review
                        </span>
                        <span
                            className="bg-blue-500 text-white rounded-md px-2 py-1 font-bold">{deckData?.total} total</span>
                    </div>
                </div>
            ...
            <div className="mb-4 bg-green-300 text-center text-white rounded-md p-4">
